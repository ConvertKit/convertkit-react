...
var e$1 = [],
    t$1 = [];
function injector_c2c2cb2a (n, r) {
...
function Mills(_ref) {
  var action = _ref.action,
      ...
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent, null) : _ref$children;
  useScript('https://f.convertkit.com/ckjs/ck.5.js');
  ...
  }, /*#__PURE__*/React.createElement("h1", null, headingText)), /*#__PURE__*/React.createElement("div", {
...
var DefaultContent$1 = function DefaultContent() {
  return /*#__PURE__*/React.createElement("p", null, "Receive tips and tricks on how to travel the world");
};
...
function Rainier(_ref) {
  var action = _ref.action,
      ...
      headingText = _ref$headingText === void 0 ? 'Join the Newsletter' : _ref$headingText,
      _ref$children = _ref.children,
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent$1, null) : _ref$children;
  ...
  }, /*#__PURE__*/React.createElement("h1", null, headingText), /*#__PURE__*/React.createElement("p", null, "\u200B")), /*#__PURE__*/React.createElement("div", {
  ...
  }, children)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("ul", {
    className: "formkit-alert formkit-alert-error",
    "data-element": "errors",
    "data-group": "alert"
  }), /*#__PURE__*/React.createElement("div", {
...
function Powell(_ref) {
  var action = _ref.action,
      ...
      disclaimerText = _ref$disclaimerText === void 0 ? "We won't send you spam. Unsubscribe at any time." : _ref$disclaimerText,
      _ref$children = _ref.children,
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent$2, null) : _ref$children;
  var bgColor = backgroundColor.join(' ').concat("/".concat(backgroundOpacity));
  useScript('https://f.convertkit.com/ckjs/ck.5.js');
...
function Charlotte(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("h1", null, headingText)), /*#__PURE__*/React.createElement("ul", {
    className: "formkit-alert formkit-alert-error",
    "data-element": "errors",
    "data-group": "alert"
  }), /*#__PURE__*/React.createElement("div", {
...
function Pine(_ref) {
  var action = _ref.action,
      ...
      headingText = _ref$headingText === void 0 ? 'Join the Newsletter' : _ref$headingText,
      _ref$children = _ref.children,
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent$3, null) : _ref$children;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !hideWarnings && !ALLOWED_FORMATS$5.includes(format) ? /*#__PURE__*/React.createElement(Warning, {
    ...
    role: "button",
    tabIndex: "0"
  }, thumbnailImage && /*#__PURE__*/React.createElement("img", {
...
function Cocoa(_ref) {
  var action = _ref.action,
      ...
      _ref$children = _ref.children,
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent$4, null) : _ref$children;
  var bgColor = backgroundColor.join(' ');
  var formRadius = "".concat(borderRadius, "px");
  useScript('https://f.convertkit.com/ckjs/ck.5.js');
  return /*#__PURE__*/React.createElement(React.Fragment, null, !hideWarnings && !ALLOWED_FORMATS$6.includes(format) ? /*#__PURE__*/React.createElement(Warning, {
    message: "This template is not available for the chosen format"
  }) : null, /*#__PURE__*/React.createElement("form", {
    action: action,
...
function Poplar(_ref) {
  var action = _ref.action,
      ...
      format = _ref$format === void 0 ? 'inline' : _ref$format,
      _ref$children = _ref.children,
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent$5, null) : _ref$children,
      _ref$backgroundImage = _ref.backgroundImage,
  ...
  var formRadius = "".concat(borderRadius, "px");
  useScript('https://f.convertkit.com/ckjs/ck.5.js');
  return /*#__PURE__*/React.createElement(React.Fragment, null, !hideWarnings && !ALLOWED_FORMATS$7.includes(format) ? /*#__PURE__*/React.createElement(Warning, {
    message: "This template is not available for the chosen format"
  }) : null, /*#__PURE__*/React.createElement("form", {
    action: action,
...
function Monterey(_ref) {
  var action = _ref.action,
      ...
      headingText = _ref$headingText === void 0 ? 'Join the newsletter' : _ref$headingText,
      _ref$children = _ref.children,
      children = _ref$children === void 0 ? /*#__PURE__*/React.createElement(DefaultContent$6, null) : _ref$children;
  var bgColor = backgroundColor.join(' ').concat("/".concat(backgroundOpacity));
  var formRadius = "".concat(borderRadius, "px");
  useScript('https://f.convertkit.com/ckjs/ck.5.js');
  return /*#__PURE__*/React.createElement(React.Fragment, null, !hideWarnings && !ALLOWED_FORMATS$8.includes(format) ? /*#__PURE__*/React.createElement(Warning, {
    message: "This template is not available for the chosen format"
  }) : null, /*#__PURE__*/React.createElement("form", {
    action: action,
...
function Form(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Template, _extends({}, props, {
    options: options,
