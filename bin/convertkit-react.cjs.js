...
ConvertKitForm.propTypes = {
  ...
  formId: PropTypes__default['default'].number.isRequired,
  submitText: PropTypes__default['default'].string,
  emailPlaceholder: PropTypes__default['default'].string,
  namePlaceholder: PropTypes__default['default'].string,
  nameLabel: PropTypes__default['default'].string,
  emailLabel: PropTypes__default['default'].string,
  showLabels: PropTypes__default['default'].bool,
  hideName: PropTypes__default['default'].bool,
  newTab: PropTypes__default['default'].bool,
  stacked: PropTypes__default['default'].bool,
  hideWarnings: PropTypes__default['default'].bool,
  backgroundImage: PropTypes__default['default'].string,
  backgroundOpacity: PropTypes__default['default'].number,
  backgroundColor: PropTypes__default['default'].arrayOf(PropTypes__default['default'].number),
