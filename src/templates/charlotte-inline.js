...
function CharlotteInline({
  ...
  return (
    <form action={action} className="seva-form formkit-form charlotte" method="post" target={newTab ? '_blank' : '_self'} data-sv-form={formId} data-uid={options.uid} data-format={format} data-version="5" data-options={JSON.stringify(options)} min-width="400 500 600 700 800" style={{ backgroundColor: 'rgb(255, 255, 255)', borderRadius: '6px' }}>
      <div data-style="full">
        ...
        <div data-element="column" className="formkit-column">
          ...
          <div data-element="fields" className="seva-fields formkit-fields">
            ...
            <button data-element="submit" className="formkit-submit" style={{ color: 'rgb(255, 255, 255)', backgroundColor: 'rgb(246, 166, 171)', borderRadius: '3px', fontWeight: 700 }}>
